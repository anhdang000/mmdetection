...
@DATASETS.register_module()
class KittiDatasetJPG(CustomDataset):
...
@DATASETS.register_module()
class KittiDatasetLP2(CustomDataset):
    CLASSES = (
        'Car', 'Van', 'Truck', 'Pedestrian', 'Person_sitting', 
        'Cyclist', 'Tram', 'Misc', 'DontCare'
        )
...
@DATASETS.register_module()
class KittiDatasetEarlyFuse55(CustomDataset):
    CLASSES = (
        'Car', 'Van', 'Truck', 'Pedestrian', 'Person_sitting', 
        'Cyclist', 'Tram', 'Misc', 'DontCare'
        )
    ...
    def load_annotations(self, ann_file):
        ...
        for image_id in tqdm(image_list, desc='Loading data'):
            ...
            # load annotations
            label_prefix = '/kaggle/input/kitti-compressed/early-fuse/5-5'
            lines = mmcv.list_from_file(osp.join(label_prefix, f'{image_id}.txt'))
